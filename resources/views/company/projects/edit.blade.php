<div class="modal fade" id="projectModalEdit" tabindex="-1" aria-labelledby="projectModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="projectFormEdit"  enctype="multipart/form-data">
                    @csrf
