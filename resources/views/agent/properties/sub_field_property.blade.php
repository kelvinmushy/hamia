   <form action="/cd" class="dropzone" id="dropzonewidget" name="dropzonewidget" enctype="multipart/form-data" method="POST">
                 ...
                 <div class="row">
                  ...
                  <div class="col-md-4">
                        ...
                        <label class="form-label">District</label>
                         <div wire:ignore>
                        <select class="form-control select_district" wire:model="district_id" required>
                         <option value="">Select</option>
