        ...
        <div class="card-body p-4">
            ...
            <div class="sidebar-menu">
                @if(auth()->user()->company)
                                ...
                                <!-- Customer/Client -->
                                @php
                                    $clientRoutes = ['customers.index']; // Add more if needed
                                    $isClientActive = in_array(Route::currentRouteName(), $clientRoutes);
                                @endphp
                                ...
                                <div class="sidebar-item mb-2">
                                    ...
                                    <div id="submenuClient" class="collapse {{ $isClientActive ? 'show' : '' }}">
                                        <a class="nav-link ps-4 {{ Route::is('customers.index') ? 'fw-bold text-primary' : 'text-dark' }}"
                                            href="{{ route('agent.customers.index') }}">Manage Customers</a>
