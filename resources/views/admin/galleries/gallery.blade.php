    ...
    <div class="row clearfix">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header bg-indigo">
                    <h2>
                        GALLERY IMAGE
                        <a href="{{ route('album') }}" class="right" title="Back"><i class="material-icons">undo</i></a>
                    </h2>
                </div>
                <div class="body">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <form action="{{route('galleries.store')}}" method="POST" id="frmFileUpload" class="dropzone">
                        @csrf
                    ...
                    <a href="{{route('album.gallery',$album_id)}}" class="btn btn-indigo btn-lg m-t-15 waves-effect" style="width:100%">
