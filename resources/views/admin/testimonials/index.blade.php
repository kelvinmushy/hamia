...
@section('content')
    ...
    <div class="block-header">
        <a href="{{route('testimonials.create')}}" class="waves-effect waves-light btn right m-b-15 addbtn">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{route('testimonials.edit',$testimonial->id)}}" class="btn btn-info btn-sm waves-effect">
                                            <i class="material-icons">edit</i>
                                        </a>
                                        <button type="button" class="btn btn-danger btn-sm waves-effect" onclick="deleteTestimonial({{$testimonial->id}})">
                                            <i class="material-icons">delete</i>
                                        </button>
                                        <form action="{{route('testimonials.destroy',$testimonial->id)}}" method="POST" id="del-testimonial-{{$testimonial->id}}" style="display:none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
