    <nav class="navbar bg-light-green">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route('dashboard') }}">Real Estate</a>
            </div>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="footer">
                                <a href="{{ route('message') }}">View All Messages</a>
                            </li>
                        </ul> --}}
                    </li>
                    <!-- #END# Notifications -->
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li>
                                <a href="{{ route('message') }}"><i class="material-icons">message</i>Messages</a>
                            </li>
                            <li>
