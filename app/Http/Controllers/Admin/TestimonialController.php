...
class TestimonialController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(isset($image)){
            ...
            $testimonial = Image::make($image)->resize(160, 160)->save(storage_path('app/public/testimonial','90') .$imagename);
    ...
    public function update(Request $request, $id)
    {
        ...
        if(isset($image)){
            ...
            $testimonialimg = Image::make($image)->resize(160, 160)->save(storage_path('app/public/testimonial','90') .$imagename);
